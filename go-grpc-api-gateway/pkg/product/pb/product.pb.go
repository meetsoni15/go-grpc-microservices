...
type GetProductResponse struct {
	...
	Status int64                              `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	Error  string                             `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	Data   *GetProductResponse_FindOneProduct `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *GetProductResponse) GetData() *GetProductResponse_FindOneProduct {
	if x != nil {
		return x.Data
	}
	return nil
...
type GetProductResponse_FindOneProduct struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetProductResponse_FindOneProduct) Reset() {
	*x = GetProductResponse_FindOneProduct{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetProductResponse_FindOneProduct) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetProductResponse_FindOneProduct) ProtoMessage() {}

func (x *GetProductResponse_FindOneProduct) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_product_pb_product_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetProductResponse_FindOneProduct.ProtoReflect.Descriptor instead.
func (*GetProductResponse_FindOneProduct) Descriptor() ([]byte, []int) {
	return file_pkg_product_pb_product_proto_rawDescGZIP(), []int{3, 0}
}

func (x *GetProductResponse_FindOneProduct) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetProductResponse_FindOneProduct) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetProductResponse_FindOneProduct) GetStock() int64 {
	if x != nil {
		return x.Stock
	}
	return 0
...
func (x *GetProductResponse_FindOneProduct) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
var file_pkg_product_pb_product_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x23, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f,
	0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xe4, 0x01, 0x0a, 0x12,
	...
	0x75, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x46, 0x69, 0x6e, 0x64,
	0x4f, 0x6e, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61,
	0x1a, 0x60, 0x0a, 0x0e, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75,
	...
	0x63, 0x65, 0x22, 0x40, 0x0a, 0x14, 0x44, 0x65, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x53, 0x74,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xfa, 0x01, 0x0a, 0x0e,
	...
	0x0a, 0x0d, 0x47, 0x65, 0x74, 0x4f, 0x6e, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4e, 0x0a, 0x0d, 0x44, 0x65, 0x63, 0x72,
...
var file_pkg_product_pb_product_proto_goTypes = []interface{}{
	...
	(*GetProductResponse_FindOneProduct)(nil), // 6: product.GetProductResponse.FindOneProduct
}
var file_pkg_product_pb_product_proto_depIdxs = []int32{
	6, // 0: product.GetProductResponse.data:type_name -> product.GetProductResponse.FindOneProduct
	0, // 1: product.ProductService.CreateProduct:input_type -> product.CreateProductRequest
	2, // 2: product.ProductService.GetOneProduct:input_type -> product.GetProductRequest
	...
	3, // 5: product.ProductService.GetOneProduct:output_type -> product.GetProductResponse
...
func file_pkg_product_pb_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_product_pb_product_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetProductResponse_FindOneProduct); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
